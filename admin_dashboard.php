...
<!-- <a href="admin.html"><button class="backbtn" type="button" ><i class="f    as fa-arrow-left"></i> Back</button></a> -->
    ...
    <center><h1>Electronics Voting System Admin Panel🗳️</h1></center>
	<h3 class="AA">
		<nav>
    <a href="admin.html" class="backbtn"><i class="fas fa-arrow-left"></i> Back</a>
...
header {
  background-image: url("../uploads/admin1.jpeg");
...
<main>
    <section class="users">
      <section id="users-role1">
        ...
        $query_role1 = "SELECT * FROM user WHERE role = 1";
      ...
      <section id="users-role2">
        ...
        $query_role2 = "SELECT * FROM user WHERE role = 2";
