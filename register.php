...
$role = $_POST['Role'];
$registration = $_['registrationnum'];
...
if ($password == $cpassword) {
    ...
    $insert = mysqli_query($connect, "INSERT INTO user (name, mobile, password, email, address, photo, role, status, votes, RegistrationNumber) VALUES ('$name', '$mobile', '$password', '$email', '$address', '$image', '$role', '0', '0','$registration')");
    if ($insert) {
        echo '<script>
